...
module Black_Line(//Check line 105 if issue that not working on nodes also 109
    input clk_3125KHz,
    input [11:0] l,c,r,
	 input [1:0] node_what_to_do,
	 input jaggad_line,
...
reg ext_left = 1, ext_right = 1, ext_centre = 1;//high on Black_Line detected
...
always@(posedge clk_3125KHz)
begin
			if(!jaggad_line)begin//by default jaggad_line is 0 and if 1 then else runs
