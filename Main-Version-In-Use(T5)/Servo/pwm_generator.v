...
//wire [16:0] value;  // Changed to wire
//assign value = ~ir ? 17'd1050 : 17'd550; //ir = 1(not detecting is 1700 / ir=0 then up;(default)
...
always@(*)
begin
	if(pwm_counter < (value))//T_on - 400 to 2400 (-90 to 90 degree)//pulse_width * 1000
	begin
		pwm_signal <= 1'b1;
	end
