...
int main(int argc, char const *argv[]) {
    ...
    */
    ...
    // prefer declaring variable like this
        ...
        // uint8_t j = ((volatile uint8_t) 0x02000094);
        // uint8_t k = ((volatile uint8_t) 0x02000098);
        // uint8_t *prev = ( uint8_t *) 0x0200009c;
        // uint8_t *dist = ( uint8_t *) 0x020000bc;
        // uint8_t *path_planned = ( uint8_t *) 0x020000DC;
        // uint8_t idx = (volatile uint8_t) 0x020000E0;
        uint32_t *graph = (uint32_t *) 0x02000010;
        uint8_t i = ((volatile uint8_t ) 0x02000090);
        ...
        // uint8_t temp = (volatile uint8_t) 0x0200010f;
        // uint8_t current = (volatile uint8_t) 0x02000110;
    #endif
        // uint32_t graph[32];
        // uint8_t i = 0;  
        // uint8_t j;
        ...
        // uint8_t idx = 0;
    // ##############################################
    // for(i=0;i<32;i++)   path_planned[i] = 0;
    ...
    // }
    // _put_value(idx);
        // for(k=(idx);k<32;k++)   path_planned[k] = 0;
        // path_planned[0] = 8;
        // path_planned[1] = 6;
        // path_planned[2] = 0;
        // path_planned[3] = 1;
